        ...
        <div className="ml-auto flex items-center gap-2 sm:gap-4">
          ...
          {user ? (
            <button
              ...
              className="inline-flex min-h-11 min-w-11 max-w-[160px] items-center justify-center gap-2 rounded-lg px-2 py-1.5 text-sm font-medium text-ink-700 transition-colors duration-fast hover:bg-surface-sunken focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40 sm:min-h-0 sm:min-w-0 sm:justify-start"
            >
              <Icon name="user" size={16} className="shrink-0 text-ink-500 sm:hidden" aria-hidden="true" />
