...
import { TEAM_PROFILES, resolveJokeProfiles } from "./teamProfiles.js";
 ...
 */
export function pickMemberForSlot(dateKey, hour, profiles = TEAM_PROFILES) {
  const pool = profiles.length > 0 ? profiles : TEAM_PROFILES;
